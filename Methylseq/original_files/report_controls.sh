...
for file1 in *.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz
do
file1_new=$(echo $file1| sed 's/.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz/_unmapped2.fq.gz/')
mv $file1 $file1_new
done

for file2 in *.fastq.gz_unmapped_reads_2.fq.gz_unmapped_reads_2.fq.gz
do
file2_new=$(echo $file2| sed 's/.fastq.gz_unmapped_reads_2.fq.gz_unmapped_reads_2.fq.gz/_unmapped2.fq.gz/')
mv $file2 $file2_new
done
