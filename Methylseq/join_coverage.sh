...
#these file names on the next 2 lines may not work because of latest changes to add $methyl_control parameter and incorrect use of "_unmapped_reads_1.fq.gz"
