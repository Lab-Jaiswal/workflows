...
echo "R2_unmapped: $R2_unmapped"

R1_unmapped2="${temp_path}/$unmethyl_control/$hydroxymethyl_control/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz"
echo "R1_unmapped2: $R1_unmapped2"
R2_unmapped2="${temp_path}/$unmethyl_control/$hydroxymethyl_control/${trimmed_R2_file_name}.fastq.gz_unmapped_reads_2.fq.gz_unmapped_reads_2.fq.gz"
echo "R2_unmapped2: $R2_unmapped2"

trimmed_R1_bismark_bam="${trimmed_R1_file_path}_bismark_bt2_pe.bam"

#unmapped_R1_file_path=$(echo $R1_unmapped| sed 's/.fq.gz//')
unmapped_R1_file_path="${temp_path}/$unmethyl_control/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1"
...
unmapped_R1_file2_path="${temp_path}/$unmethyl_control/$hydroxymethyl_control/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1"
echo "unmapped_R1_file2_path: $unmapped_R1_file2_path"
unmapped_R1_file2_name="${unmapped_R1_file2_path##*/}"
echo "unmapped_R1_file2_name: $unmapped_R1_file2_name"
R1_unmapped_bismark_PE_report2="${unmapped_R1_file2_name}_bismark_bt2_PE_report.txt"

unmapped_R1_bismark_bam2="${unmapped_R1_file2_path}_bismark_bt2_pe.bam"
...
unmapped_unmapped_R1="${temp_path}/$unmethyl_control/$hydroxymethyl_control/$methyl_control/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz"
unmapped_unmapped_R2="${temp_path}/$unmethyl_control/$hydroxymethyl_control/$methyl_control/${trimmed_R2_file_name}.fastq.gz_unmapped_reads_2.fq.gz_unmapped_reads_2.fq.gz_unmapped_reads_2.fq.gz"
...
trimmed_unmapped_R1_bam="${temp_path}/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam"
...
unmapped_path2=$temp_path/$unmethyl_control/$hydroxymethyl_control

if [ ! -f "$unmapped_path2/$methyl_control/${unmapped_R1_file_name}_bismark_bt2_PE_report.txt" ]; then
    cd $unmapped_path
        echo "$unmapped_path2/$methyl_control/${unmapped_R1_file_name}_bismark_bt2_PE_report.txt does not exist yet" 
        echo Run bismark on $R1_unmapped2 and $R2_unmapped2
    bismark --bam --maxins 800 $temp_genomes_path/$methyl_control_fasta -1 $R1_unmapped2 -2 $R2_unmapped2 -o $unmapped_path2/$methyl_control --unmapped --nucleotide_coverage --multicore $cores
...
if [ ! -f "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/${unmapped_R1_file2_name}_bismark_bt2_pe_splitting_report.txt" ]; then 
    cd $temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control
        echo "$temp_path/$unmethyl_control/$hydroxymethyl_control/${unmapped_R1_file2_name}_bismark_bt2_pe_splitting_report.txt does not exist yet"
    bismark_methylation_extractor --gzip --cytosine_report --bedGraph --genome_folder $temp_genomes_path/$methyl_control_fasta $unmapped_R1_bismark_bam2 --multicore $cores
...
if [ ! -f "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${unmapped_R1_file_name}.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam" ]; then   
    cd $temp_path/$unmethyl_control/$hydroxymethyl_control
        echo "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${unmapped_R1_file_name}.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam does not exist yet"
    bismark --bam --maxins 1000 $temp_genomes_path/$genome_name -1 $unmapped_unmapped_R1 -2 $unmapped_unmapped_R2 -o $temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment --unmapped --nucleotide_coverage --multicore $cores
        #--parallel ${SLURM_CPUS_PER_TASK}
    
    #copy all results back to #seq_path and updates to the genome
    rsync -vur $temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/ $seq_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/
...
if [ ! -f "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.sorted.bam" ]; then
    cd "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment"
        echo "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.sorted.bam does not yet exist"
    samtools sort "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam" -o  "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.sorted.bam"
    samtools index "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.sorted.bam"
    rsync -vur $temp_path/ $seq_path
...
if [ ! -f "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/split_bams/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.1.bam" ]; then
    cd "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment"
    echo "$temp_path/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/split_bams/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.1.bam does not yest exist"
    ...
    for i in ${chromosomes[@]}
        do
            chr="${chromosome}${i}"
            echo "$chr"
            samtools view -b "${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.sorted.bam" $chr > "split_bams/${trimmed_R1_file_name}.fastq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1.fq.gz_unmapped_reads_1_bismark_bt2_pe.bam.${chr}.${sample_name}.bam"  
        done
    rsync -vur $temp_path/ $seq_path
