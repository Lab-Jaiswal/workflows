...
rsync -vur "$data_path/fastq/$unmethyl_control/$hydroxymethyl_control/$methyl_control/genome_alignment/split_bams" "$temp_path/$unmethyl_control/$hydroxymethyl_control/genome_alignment/split_bams"
...
rsync -vur "$genomes_path/$methyl_control_fasta" $temp_genomes_path
