...
#Download the 1000 youngest file list using
...
#Get a list of all of the file paths using
...
#Filter out all filepaths to only list the 1000 youngest using:
...
#upload the 1000 youngest filepath
